...
export type GetItemsFromCityQuery = { __typename?: 'Query', itemsFromCity: { __typename?: 'ItemCitySearchResult', resultsFound: number, items: Array<{ __typename?: 'Item', id: string, name: string, imgUrl: string, category: string, prices: Array<{ __typename?: 'Price', price: number, createdAt: string }>, stores: { __typename?: 'Store', id: string, name: string, street: string, city: string, postalCode?: string | null, zipCode?: string | null, state?: string | null, province?: string | null, country: string } }> } };
...
export type GetLocationsQuery = { __typename?: 'Query', locations: Array<{ __typename?: 'Location', _count: number, country: string, city: string, province?: string | null, state?: string | null }> };
