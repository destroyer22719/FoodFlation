...
export type GetItemAndItsStoreDataQuery = { __typename?: 'Query', item?: { __typename?: 'Item', category: string, imgUrl: string, stores: { __typename?: 'Store', street: string, city: string, postalCode?: string | null, zipCode?: string | null, state?: string | null, province?: string | null, country: string }, prices: Array<{ __typename?: 'Price', createdAt: string, price: number }> } | null };
